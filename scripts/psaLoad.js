$(document).ready(() => {
    ...
    document.getElementById('gifimg').style.visibility = "hidden";
});
...
ref.on("child_added", data => {
    ...
    document.getElementById('loader').innerText = "Problem Solving Approaches Lab: Available List of Programs.";
